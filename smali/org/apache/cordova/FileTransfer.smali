...
.method public download(Ljava/lang/String;Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    .line 419
    iget-object v9, p0, Lorg/apache/cordova/FileTransfer;->ctx:Lorg/apache/cordova/api/CordovaInterface;

    invoke-interface {v9, p1}, Lorg/apache/cordova/api/CordovaInterface;->isUrlWhiteListed(Ljava/lang/String;)Z
    ...
    .end local v1    # "bytesRead":I
    .end local v2    # "connection":Ljava/net/HttpURLConnection;
    .end local v5    # "fileUtil":Lorg/apache/cordova/FileUtils;
    .end local v6    # "inputStream":Ljava/io/InputStream;
    .end local v7    # "outputStream":Ljava/io/FileOutputStream;
    .end local v8    # "url":Ljava/net/URL;
    :cond_1
    ...
    const-string v10, "Error: Unable to connect to domain"
